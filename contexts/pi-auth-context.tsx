...
export function PiAuthProvider({ children }: { children: ReactNode }) {
  ...
  const initialize = async () => {
    ...
    const hasPiSDK = checkPiBrowser();
    setIsPiBrowser(hasPiSDK);

    // If not in Pi Browser, skip authentication and show app immediately
    if (!hasPiSDK) {
      console.log("[PiAuth] Not in Pi Browser - skipping authentication");
